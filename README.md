...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1783&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-viridis-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-viridis` can be installed with `conda`:
...
```
mamba install r-viridis
```

It is possible to list all of the versions of `r-viridis` available on your platform with `conda`:
...
```
mamba search r-viridis --channel conda-forge
```
...
mamba repoquery search r-viridis --channel conda-forge

# List packages depending on `r-viridis`:
mamba repoquery whoneeds r-viridis --channel conda-forge

# List dependencies of `r-viridis`:
mamba repoquery depends r-viridis --channel conda-forge
```
